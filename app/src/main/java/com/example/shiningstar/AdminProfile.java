...
public class AdminProfile extends Fragment {
    ...
    private void UpdateData(){
        ...
        databaseReference.child("admins").child(uid).child("name").setValue(namesss);
        databaseReference.child("admins").child(uid).child("email").setValue(emails);
        databaseReference.child("admins").child(uid).child("password").setValue(passwords);
