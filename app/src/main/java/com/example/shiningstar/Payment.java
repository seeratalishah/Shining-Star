...
public class Payment extends AppCompatActivity {
    ...
    private void upload()
    {
        ...
        if(image.getDrawable() == null)
        {
            ...
            parent.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    parent.child(uid).child("receiptID").setValue(receiptID);
                        ...
                        ref.putFile(filePath)
                                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        Toast.makeText(Payment.this,"Receipt Sent Successfully", Toast.LENGTH_LONG).show();

                                        Intent i = new Intent(Payment.this,Parent.class);
