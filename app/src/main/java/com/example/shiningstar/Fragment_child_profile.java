 ...
 */
public class Fragment_child_profile extends Fragment {


    public Fragment_child_profile() {
        // Required empty public constructor
    }

    public static Fragment_child_profile newInstance(String id,String name) {

        Bundle args = new Bundle();
        args.putString("id",id);
        args.putString("name",name);
        Fragment_child_profile fragment = new Fragment_child_profile();
