 ...
 */
public class Fragment_child_check_in extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView =(androidx.recyclerview.widget.RecyclerView) v.findViewById(R.id.child_checkin_recyclerview);
