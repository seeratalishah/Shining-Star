 ...
 */
public class Fragment_child_custom_activity extends Fragment {
    ...
    public Fragment_child_custom_activity() {
    ...
    public static Fragment_child_custom_activity newInstance(String param1) {
        Fragment_child_custom_activity fragment = new Fragment_child_custom_activity();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =  inflater.inflate(R.layout.fragment_fragment_child_custom_activity, container, false);
